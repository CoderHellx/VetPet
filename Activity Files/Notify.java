        ...
        public void onBindViewHolder(@NonNull NotifyViewHolder holder, int position) {
            ...
            holder.accept.setOnClickListener(v -> {
                db.setTicket(notification.applicationId, true, userId)
                        .addOnSuccessListener(unused -> {
                            db.deleteNotification(notification.applicationId, userId);
                            Toast.makeText(Notify.this, "Approved and Notification Deleted.", Toast.LENGTH_SHORT).show();
                            finish(); // or update UI
                        });
            });
            ...
            holder.reject.setOnClickListener(v -> {
                db.setTicket(notification.applicationId, false, userId)
                        .addOnSuccessListener(unused -> {
                            db.deleteNotification(notification.applicationId, userId);
                            Toast.makeText(Notify.this, "Rejected and Notification Deleted.", Toast.LENGTH_SHORT).show();
                            finish(); // or update UI
                        });
            });
